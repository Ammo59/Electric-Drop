...
# Define parameters for displaying images from the 8kV video
file = str(dataDirectory+'/Temp150KV8.avi') # location and name of the video file
...
xBottom = 660 # bubble nucleation spot (x location)
...
fig.savefig('Figure_3.png', bbox_inches='tight', pad_inches=0.0, dpi=300) #frameon=True
